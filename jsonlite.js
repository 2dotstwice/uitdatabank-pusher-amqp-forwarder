/**
 * Code taken from http://deerchao.net/projects/jsonlite/index.htm and converted
 * to a Node module.
 */
/**
 *
 * @param string source
 * @param boolean jsonObjectFormat
 * @returns {*}
 */
exports.parse = function (source, jsonObjectFormat) {
